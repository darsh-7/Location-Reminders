...
class GeofenceTransitionsJobIntentService : JobIntentService(), CoroutineScope {
    ...
    override fun onHandleWork(intent: Intent) {
        Log.i(TAG, "onHandleWork is called")
    ...
    private fun sendNotification(geofence: Geofence) {
        Log.i(TAG, "sendNotification is called")
...
//        //        TODO: call this to start the JobIntentService to handle the geofencing transition events
//        fun enqueueWork(context: Context, intent: Intent) {
//            enqueueWork(context, GeofenceTransitionsJobIntentService::class.java, JOB_ID,
//                intent
//            )
//        }
//    }
...
//
//    override fun onHandleWork(intent: Intent) {
//        Log.i("SaveReminderFragment", "onHandleWork is called")
...
//        Log.i("SaveReminderFragment", "sendNotification is called")
//
